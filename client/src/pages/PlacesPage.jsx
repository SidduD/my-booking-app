            ...
            places.map((place) => (
              ...
              >
                <div className="relative flex grow items-center sm:items-start gap-3">
                  <div className="absolute right-2 top-1 " onClick={(e) => handleDelete(place._id, e)}>
                  ...
                  <div className="grow-0 shrink">
                    <h2 className="text-sm sm:text-xl font-semibold truncate-multiline1 pr-3 mr-3">{place.title}</h2>
